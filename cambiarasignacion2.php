...
$result=$objconsulta->actualizarasignacion($codigo,$id_cate,$conexion);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<table>
      <tr>
        <td width="81">Estado de la actualizacion</td>
        <td width="103"><?php echo "Libro actualizado con exito"?></td>
      </tr>
    </table>
    <br>
        </section><!-- content -->
                        <div>
                    <a href="inicioadmin.html">Ir al inicio</a>
                    <a href="cambiarasignacion.php">Actualizar otro libro</a>
                </div>
    <!-- container -->
