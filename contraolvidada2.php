...
$result=$objconsulta->cambiarcontraseña($c_socio,$contraseña,$conexion);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="box-layout" style=background-image:url(https://img.freepik.com/fotos-premium/estanteria-borrosa-muchos-libros-antiguos-libreria-o-biblioteca_36051-477.jpg)>
   <!-- Page Loader -->
...
<table>
      <tr>
        <td width="81">Confirmación de cambio</td>
        <td width="103"><?php echo "Su contraseña fue cambiada con éxito"?></td>
      </tr>
    </table>
    ...
    <br>
                        ...
                        <div>
                    <a href="inicio_s_u1.html">Volver al inicio de sesión</a>
