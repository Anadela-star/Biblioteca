...
<table>
      <tr>
        <td width="81">Estado del pedido</td>
        <td width="103"><?php echo "Pedido realizado acercate a la sucursal para recibir el prestamo del libro"?></td>
      </tr>
    </table>
    <br>
        </section><!-- content -->
                        <div>
                    <a href="iniciosocio.html">Ir al inicio</a>
                    <a href="prestarlibro.php">Prestar otro libro</a>
                </div>
    <!-- container -->
