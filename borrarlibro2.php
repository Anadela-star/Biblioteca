...
$result=$objconsulta->quitarlibro($codigo,$conexion);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<table>
      <tr>
        <td width="81">Estado de la consulta</td>
        <td width="103"><?php echo "Libro borrado con éxito"?></td>
      </tr>
    </table>
    <br>
        </section><!-- content -->
                    ...
                    <a href="borrarlibro.php">Borrar otro libro</a>
                </div>
    <!-- container -->
