   ...
   <div class="inner-conterner">
      ...
      <div class="slider-wrapper">
         <div class="fr-slider">
            ...
            <div class="slide">
               <img data-fixed class="slide-bg" src="https://img.freepik.com/fotos-premium/estanteria-borrosa-muchos-libros-antiguos-libreria-o-biblioteca_36051-477.jpg?w=2000" alt="Slide">
            </div>
         </div>
      </div>
      <!-- End Slider -->
      ...
      <div class="footer-holder">
         <div class="container">
            <footer class="site-footer">
               <div class="row">
                  <div class="col-md-6">
                     <p>© Copyright 2022 | <a href="http://templatestock.co" target="_blank">Template Stock</a></p>
                  </div>
                  <div class="col-md-6">
                     <ul class="footer-nav">
