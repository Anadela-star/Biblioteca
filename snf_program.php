...
$result=$objconsulta->mostrarsociosnofiables($conexion);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<table>
    <thead>
        <tr>
            <th>ID del socio</th><th>Nombre</th><th>Direccion</th>
        </tr>
    </thead>
    ...
    <?php for($i=0;$row=mysqli_fetch_array($result);$i++){
        ...
        ?>
        <td> <?php echo $row['c_socio']?> </td> <td> <?php echo $row['nombre']?>  </td><td> <?php echo $row['direccion']?> </td> 
    </tr>
