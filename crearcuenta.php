...
<table>
      <tr>
        <td width="81">Querido usuario:</td>
        <td width="103"><?php echo "Para realizar dicha acción deberá crearse una cuenta en nuestra plataforma podrá hacerlo en los links de abajo"?></td>
      </tr>
    </table>
    <br>
        </section><!-- content -->
                    ...
                    <a href="registrar_usuarios_socios.html">Crear cuenta</a>
                </div>
    <!-- container -->
