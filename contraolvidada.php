...
<body class="box-layout">
   ...
   <div class="inner-conterner">
      ...
      <header class="site-header">
                  ...
                  <div class="header-table col-md-12">
                     ...
                     <nav id="nav-wrap" class="main-nav">
                        ...
                        <ul class="sf-menu">
                           ...
                           <li>
                              <a href="cate.html">Nuestro catalogo </a>
                           </li>
                           <li>
                              <a href="login_g.html">Iniciar sesion</a>
                           </li>
                           <li>
                              <a href="regis.html">Registrarse</a>
                           </li>
                           <li>
                              <a href="portada.html">Acerca de nosotros</a>
                           </li>
                        </ul>
                     </nav>
                  </div>
        ...
        <section id="content">
            <form id="form1" name="form1" method="post" action="contraolvidada2.php">
                <h1>Cambiar contraseña</h1>
                  <div>
                    <input name="c_socio" type="text" placeholder="Su numero de socio" required="" id="username"  />
                </div>
                <div>
                    <input name="contraseña" type="text" placeholder="Nueva contraseña" required="" id="username"  />
                </div>
                <div>
